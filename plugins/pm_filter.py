...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         text="<b>ʜᴇʏ ᴅᴜᴅᴇ 😍 ,\n\nʏᴏᴜ ᴄᴀɴ'ᴛ ɢᴇᴛ ᴍᴏᴠɪᴇs ꜰʀᴏᴍ ʜᴇʀᴇ. ʀᴇǫᴜᴇsᴛ ᴏɴ ᴏᴜʀ <a href='https://t.me/+tr6QuDlL1j1kMjc1'>ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ</a> ᴏʀ ᴄʟɪᴄᴋ ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ​👇</b>",   
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ​ ", url=f"t.me/+tr6QuDlL1j1kMjc1")]]))
    ...
    if query.data.startswith("file"):
        ...
        await client.send_cached_media(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                  InlineKeyboardButton("❤️‍🔥 ᴍᴏᴠɪᴇs​ ❤️‍🔥", url='https://t.me/+e_UqPGvuQ5E5NGU1')
                 ]
                ]
            )
        )
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🧑‍🎓 ᴏᴡɴᴇʀ​', callback_data='owner_info'),
            InlineKeyboardButton('🌿 sᴜᴘᴘᴏʀᴛ​', url='https://t.me/+8vZTQtzo0lBmNDY9')
            ],[      
            InlineKeyboardButton('💠 ʜᴇʟᴘ 💠', callback_data='help'),
            InlineKeyboardButton('♻️ ᴀʙᴏᴜᴛ ♻️', callback_data='about')
            ],[
...
async def auto_filter(client, msg, spoll=False):
    ...
    if not spoll:
        message = msg
        settings = await get_settings(message.chat.id)
        if message.startswith("/") or content.startswith("#"): return # ignore commands
